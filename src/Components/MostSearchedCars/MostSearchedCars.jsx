...
import { FaGasPump,  FaRegKeyboard,FaPalette,FaCogs  } from "react-icons/fa";
import { Link } from "react-router-dom";
import axios from "axios";

const categories = [ "All","Sedan", "SUV", "Convertible", "Hatchback", "Coupe", "Sport"];
...
export default function MostSearchedCars() {
  ...
  // فلترة العربيات بناءً على specifications.type
  const filteredCars =
    activeCategory === "All"
      ? cars
      : cars.filter(
